...
export const DEFAULT_MASS_MIN = 1
export const DEFAULT_MASS_MAX = 3
export const DEFAULT_SIZE_MIN = 1
export const DEFAULT_SIZE_MAX = 3
export const DEFAULT_ROTATE = false
...
export const DEFAULT_OPACITY_MIN = 0
...
export const BASE_LAYER_CONFIG: BaseLayerConfig = {
...
export const DEFAULT_IMAGE_LAYER: ImageLayerConfig = {
  ...BASE_LAYER_CONFIG,
  mode: 'image',
  image: DEFAULT_IMAGE,
...
export const DEFAULT_LAYERS: SimpleLayerConfig[] = []
